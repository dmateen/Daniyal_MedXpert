    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doctor_dbHandler_Updateprofile.getRecord(new SessionManager(this).getCNIC(), new doctor_Db_HandlerUpdateProfile.GetRecordCallbackdoctor() {
            ...
            public void onSuccess(SignupUser_Pojo userPojo) {
                ...
                cnicEditText.getEditText().setText(dataFormDB.getCnic());
                cnicEditText.setEnabled(false);
                cnicEditText.setEndIconMode(TextInputLayout.END_ICON_NONE);;
                countryCodeEditText.getEditText().setText(dataFormDB.getCountryCode().replace('+',' ').trim());
                ...
                if (dataFormDB.getGender().equals("Male")) {
                    ...
                    RadioButton femaleRadioBtn=findViewById(R.id.femaleRadioButton);
