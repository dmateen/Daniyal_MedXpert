package medxpert.main.daniyal_medxpert.RecyclerViewAdapter;
...
public class MedicineAdapter extends RecyclerView.Adapter<MedicineAdapter.viewHolder>{
    ...
    private ArrayList<POJORoutineIntake> Medicinelist;

    private View.OnClickListener addClickListener;
    private View.OnClickListener minusClickListener;
    private View.OnClickListener deleteClickListener;

    public MedicineAdapter(Context context, ArrayList<POJORoutineIntake> medlist)
    {
...
public void onBindViewHolder(@NonNull MedicineAdapter.viewHolder holder, @SuppressLint("RecyclerView") int position) {
    POJORoutineIntake obj = Medicinelist.get(position);
